# Cave River Quest Asset Attribution

Assets used in the Cave River Quest 3D reward game.
...
- `poly-pizza/chest-quaternius.glb`
  - Title: Chest
  - Creator: Quaternius
  - Source: https://poly.pizza/m/O72u4Drp8k
  - License: CC0 1.0

- `poly-pizza/robot-quaternius-animated.glb`
...
- `kenney/dungeon/gate-metal-bars.glb`
